...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/toaddPage">新增</a>
        </div>
        <div class="col-md-4 column">
            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach items="${list}" var="book" >
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/book/toupdatePage/${book.getBookID()}">更改</a> |
